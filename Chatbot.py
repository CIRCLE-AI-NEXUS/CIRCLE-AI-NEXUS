...
.chat-header { text-align:center; padding:16px 0 8px 0;
    border-bottom:1px solid rgba(255,255,255,0.08); margin-bottom:16px; }
.chat-name { font-size:1.1rem; font-weight:700;
    background:linear-gradient(135deg,#00f5d4,#00bbf9);
    -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
.chat-status { font-size:0.75rem; color:#00f5d4; margin-top:2px; }
.bubble-user { background:linear-gradient(135deg,#00f5d4,#00bbf9); color:#000;
    padding:10px 14px; border-radius:16px 16px 4px 16px;
    margin:6px 0; margin-left:15%; font-size:0.9rem; }
.bubble-ai { background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.1);
    color:#e8eaf6; padding:10px 14px; border-radius:16px 16px 16px 4px;
    margin:6px 0; margin-right:15%; font-size:0.9rem; line-height:1.5; }
</style>
...
if not st.session_state.messages:
    ...
    sugs = ["Ada promo apa?", "Menu & harga?", "Cara reservasi?", "Dimana lokasinya?", "Ada wifi?"]
    cols = st.columns(2)
...
st.markdown('<div style="text-align:center;color:#2d3748;font-size:0.7rem;margin-top:20px">Powered by CIRCLE AI 🧠</div>', unsafe_allow_html=True)